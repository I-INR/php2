    ...
    while($baris = mysqli_fetch_array($result)){
        echo "<table style='width:100%; text-align: center; border: 1px solid black; background-color: #00ff99;'>
                <tr>               
                    ...
                    <td style='width:50%; text-align: center; border: 1px solid black;'><a href='ubah_data.php?id_buku=$baris[0]'>Ubah &nbsp</a></td>
                    <td style='width:50%; text-align: center; border: 1px solid black;'><a href='hapus.php?id_buku=$baris[0]'>Hapus</a></td>
                </tr>
            </table><br><br><br>";
        $a++;}
    echo "<a href='formulir.php'><h1 style='text-align: center;'>Tambah data</h1></a>";
    $conn->close();
?>
